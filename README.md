...
| `TopDownRun` | **下山** | 9 米高、56° 俯角；惯性延迟跟随、转弯侧倾、速度拉高镜头；W 就是"屏幕往上"= 他真正要去的方向。镜头带避障——逃跑是从礼厅门口开始的，不处理的话它会直接从屋顶穿出去 |
...
另外，所有人物脚下都有一团程序化的接触阴影：没有它的时候，人在漫反射的场景里像
"贴"在地上，稍微远一点就和地面对比度一起消失。俯视镜头的高度也是量出来的——
15.5 米时一个 1.78 米的人只占画面 5.9%，"俯视跑步"就变成了"看地图"。
